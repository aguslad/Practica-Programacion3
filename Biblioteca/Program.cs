...
Console.WriteLine("Buscando el material 'M002'...");
Material? materialEncontrado = service.BuscarMaterialPorId("M002");

if (materialEncontrado != null)
{
    Console.WriteLine("¡Éxito! " + materialEncontrado.ObtenerFicha());
}

Console.WriteLine("Buscando el material 'M999'...");
Material? materialNoEncontrado = service.BuscarMaterialPorId("M999");

if (materialNoEncontrado != null)
{
    Console.WriteLine(materialNoEncontrado.ObtenerFicha());
}

Console.WriteLine("Buscando un ID vacío...");
Material? materialInvalido = service.BuscarMaterialPorId("   ");

if (materialInvalido != null)
{
    Console.WriteLine(materialInvalido.ObtenerFicha());
}
