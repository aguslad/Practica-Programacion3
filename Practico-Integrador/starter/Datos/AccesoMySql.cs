...
public class AccesoMySql : IAccesoDatos
{
    ...
    "Host=localhost;Port=3306;Database=practico;Username=root;Password=Curso.NET2026";
    ...
    public void CrearEstructura()
    {
        ...
        "Host=localhost;Port=3306;Database=mysql;Username=root;Password=Curso.NET2026";

        using (var connBD = new MySqlConnection(cadenaAdmin))
        {
            connBD.Open();
    ...
    public void InsertarDatosPrueba()
    {
        ...
        {
            // --- CATEGORÍAS ---
            cmd.CommandText = "INSERT INTO Categorias(nombre) VALUES(@nombreCat);";
            ...
            // --- PRODUCTOS ---
            string sqlProducto = "INSERT INTO Productos (nombre, precio, stock, categoria_id) VALUES (@nombreProd, @precio, @stock, @categoriaId);";
            ...
            // --- CLIENTES ---
            string sqlCliente = "INSERT INTO Clientes(nombre, email) VALUES(@nombreCliente, @email);";
            ...
            // --- PEDIDOS ---
            string sqlPedido = "INSERT INTO Pedidos(cliente_id, fecha) VALUES(@clienteId, @fecha);";
